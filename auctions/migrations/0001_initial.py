    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.ImageField(blank=True, null=True, upload_to='auctions/')),
                ('initial_price', models.IntegerField()),
                ('highest_bid', models.IntegerField(blank=True, null=True)),
                ('categories', models.CharField(choices=[('Electronics', 'Electronics'), ('Fashion', 'Fashion'), ('Home & Garden', 'Home & Garden'), ('Sports & Outdoors', 'Sports & Outdoors'), ('Toys & Games', 'Toys & Games'), ('Books, Movies & Music', 'Books, Movies & Music'), ('Vehicles', 'Vehicles'), ('Collectibles & Art', 'Collectibles & Art'), ('Other / Miscellaneous', 'Other / Miscellaneous')])),
